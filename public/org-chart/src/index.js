...
const Drawing = require('@mindfusion/drawing');
const Graphs = require('@mindfusion/graphs');

/// <reference path="JsDiagram-vsdoc.js" />

var Diagram = Diagramming.Diagram;
var Behavior = Diagramming.Behavior;
var Alignment = Diagramming.Alignment;
var AnchorPattern= Diagramming.AnchorPattern;
var TableNode= Diagramming.TableNode;
var Shape= Diagramming.SimpleShape;
var Font = Drawing.Font;
var Rect = Drawing.Rect;
var Text = Drawing.Text;
var Thickness = Drawing.Thickness;
var Event= Diagramming.Events;
var GlassEffect= Diagramming.GlassEffect;
var Style= Diagramming.Style;
var SimpleShape= Diagramming.SimpleShape;
var ImageAlign = Drawing.ImageAlign;
var LinkShape= Diagramming.LinkShape;
...
class OrgChartNode extends TableNode {
	constructor(parent, boss) {
		...
		this.handlesStyle = Diagramming.HandlesStyle.MoveOnly;
		this.cellFrameStyle = Diagramming.CellFrameStyle.None;
		this.brush = "purple";
		this.shape = SimpleShape.RoundedRectangle;

		this.setFullName("Name");
		this.setTitle("title");
		this.imageLocation = placeholder;
		this.setId();
		this.setBoss(boss);
		this.setHierarchy();
...
document.addEventListener("DOMContentLoaded", function () {
	...
	diagramView = Diagramming.DiagramView.create(document.getElementById("diagram"));
