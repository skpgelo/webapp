  ...
  public function index()
	{
		...
		return view('survey/sur_main', $this->data);
	}
//--------------------------------------------------------------------
/**
	...
	*/
	public function create()
	{
		...
		return view('survey/sur_create', $this->data);
	}
//--------------------------------------------------------------------
/**
	...
	*/
	public function revamp(int $sId = null)
	{
		...
		return view('survey/sur_revamp', $this->data);
	}
	//--------------------------------------------------------------------
	/**
		...
		*/
		public function fetch(int $sId = null)
		{
			...
			$this->data['surveys'] = $this->sModel->where('user_id', session('user.user_id'))->findAll();
			return view('survey/sur_plural', $this->data);
		}
//--------------------------------------------------------------------
/**
	...
	*/
	public function affix(int $sId = null)
	{
		...
		return view('survey/sur_affix', $this->data);
	}
//--------------------------------------------------------------------
/**
