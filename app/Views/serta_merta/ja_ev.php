                  ...
                  <!-- <canvas id="myChart" height="182"></canvas> -->
                    <div class="table-responsive">
                        ...
                        <tbody class="text-left">
                                <td scope="row">
                                <img style="margin-right: 25px ; margin-left: 25px ; width:90% ;" src="<?= base_url(); ?>img/jalur_evakuasi.jpg" >
                                </td>
                            </tbody>
                        </table>
                    ...
                    <table class="table table-striped mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a><img class="img-responsive" src="<?= base_url('stisla/assets/img/avatar/avatar-1.png');?>" alt="avatar" style="margin-right: 40px ; margin-left: 40px ; width:100% ;" class="rounded-circle mr-1"> Bagus Dwi Cahya</a>
                          </td>
                          <td>
                            <a class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                            <a class="btn btn-danger btn-action" data-toggle="tooltip" title="Delete" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="alert('Deleted')"><i class="fas fa-trash"></i></a>
