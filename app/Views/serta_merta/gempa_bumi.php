<?php echo $this->extend('base/skeleton'); ?>
                    ...
                    <div class="table-responsive">
                        <table>
                            ...
                            <tbody class="text-left">
                                ...
                                echo "<img style='margin-right: 20px ; margin-left: 20px ; width:95% ;' src=\"https://data.bmkg.go.id/DataMKG/TEWS/" . $data->gempa->Shakemap . "\" alt=\"Gempabumi Terbaru\" width='750' height='auto'>";
                                ?>
                                </td>
                                <td scope="row" style="margin-right: 30px ; margin-left: 30px ; width:50% ;">
                                <?php
