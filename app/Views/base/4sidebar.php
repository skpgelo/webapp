      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
                <img alt="image" src="<?= base_url(); ?>img/Kemensos.png" style="widht: auto; height:3em" />
                <!-- <img alt="image" src="<?= base_url() ?>stisla_/dist/assets/img/avatar/avatar-1.png" style="widht:auto; height:5em" class="rounded-circle mr-20"> -->
              <span style="color: red;"><b>BBPPKS<a href="index.html"></span><i style="color: blue;"> BANDUNG</i></a></b>             
          </div>
