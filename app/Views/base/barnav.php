...
<nav class="navbar navbar-expand-lg main-navbar">
    <form class="form-inline mr-auto">
      ...
      <a href="#" style="color:antiquewhite; font-size:medium; font-family: dancing-script, cursive; font-optical-sizing: auto;"><?= $sub_title ?>
        <!-- Pejabat Pengelola Informasi dan Data <b>::</b> Balai Besar Pendidikan dan Pelatihan Kesejahteraan Sosial Bandung</a> -->
        ...
        <div class="search-result">
          ...
          <div class="search-item">
            <a href="#">
              <img class="mr-3 rounded" width="30" src="<?= base_url('products/product-3-50.png');?>" alt="product">
              oPhone S9 Limited Edition
            </a>
          </div>
          <div class="search-item">
            <a href="#">
              <img class="mr-3 rounded" width="30" src="<?= base_url('products/product-2-50.png');?>" alt="product">
              Drone X2 New Gen-7
            </a>
          </div>
          <div class="search-item">
            <a href="#">
              <img class="mr-3 rounded" width="30" src="<?= base_url('products/product-1-50.png');?>" alt="product">
              Headphone Blitz
            </a>
          </div>
          <div class="search-header">
