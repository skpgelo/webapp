...
<!-- awal div card -->
    ...
    <div class="container my-5">
        <h2 class="fw-bold mb-4 border-start border-primary border-4 ps-2"></h2>
                ...
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-lg-7 overflow-hidden">
                        <?php if (!empty($highlight['cover_image'])): ?>
                            <img src="<?= esc($highlight['cover_image']) ?>" class="img-fluid highlight-img" alt="Cover Berita Terbaru" onerror="this.src='/img/no-image.jpg'">
                        ...
                        <div class="card-body p-4 p-xl-5">
                            ...
                            <h1 class="card-title h2 fw-xl-bold text-dark lh-sm mb-3">
                                <a href="<?= base_url('berita/detail/' . $highlight['id']) ?>" class="text-decoration-none text-dark link-primary">
                                    <?= esc($highlight['judul_berita']) ?>
                                </a>
                            </h1>
                            
                            <!-- Meta Data info -->
                            <div class="text-muted small mb-4 d-flex align-items-center gap-2">
                                <span>Oleh <strong><?= esc($highlight['kontributor']) ?></strong></span>
                                <span>•</span>
